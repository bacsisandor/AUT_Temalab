...
goog.ui.ControlRenderer.prototype.decorate = function (a, b) {
    ...
    var d = 0, e = this.getCssClass(), f = this.getStructuralCssClass(), g = !1, h = !1, k = !1, n = goog.array.toArray(goog.dom.classlist.get(b));
...
goog.ui.tree.BaseNode.prototype.toSafeHtml = function () {
    var a = this.getTree(), b = !a.getShowLines() || a == this.getParent() && !a.getShowRootLines() ? this.config_.cssChildrenNoLines : this.config_.cssChildren;
...
Blockly.WorkspaceSvg.prototype.setupDragSurface = function () {
    if (this.useWorkspaceDragSurface_ && !this.isDragSurfaceActive_) {
        ...
        var a = this.svgBlockCanvas_.previousSibling, b = this.getParentSvg().getAttribute("width"), c = this.getParentSvg().getAttribute("height"), d = Blockly.utils.getRelativeXY(this.svgBlockCanvas_);
...
Blockly.WorkspaceSvg.getContentDimensionsBounded_ = function (a, b) {
    var c = Blockly.WorkspaceSvg.getContentDimensionsExact_(a), d = b.width, e = b.height, f = d / 2, g = e / 2, h = Math.min(c.left - f, c.right - d), k = Math.min(c.top - g, c.bottom - e);
    return {
        left: h,
        top: k,
...
Blockly.WorkspaceSvg.getTopLevelWorkspaceMetrics_ = function () {
    var a = Blockly.WorkspaceSvg.getDimensionsPx_(this.toolbox_), b = Blockly.WorkspaceSvg.getDimensionsPx_(this.flyout_), c = Blockly.svgSize(this.getParentSvg());
...
Blockly.Block.prototype.setColour = function (a) {
    var b = Number(a);
    if (!isNaN(b) && 0 <= b && 360 >= b) this.hue_ = b, this.colour_ = Blockly.hueToRgb(b); else if (goog.isString(a) && a.match(/^#[0-9a-fA-F]{6}$/)) this.colour_ = a, this.hue_ = null; else throw"Invalid colour: " + a;
};
...
Blockly.Block.newFieldImageFromJson_ = function (a) {
    var b = Blockly.utils.replaceMessageReferences(a.src), c = Number(Blockly.utils.replaceMessageReferences(a.width)), d = Number(Blockly.utils.replaceMessageReferences(a.height));
...
Blockly.BlockSvg.prototype.getRelativeToSurfaceXY = function () {
    var a = 0, b = 0, c = this.useDragSurface_ ? this.workspace.blockDragSurface_.getGroup() : null, d = this.getSvgRoot();
    if (d) {
        do {
...
Blockly.BlockSvg.prototype.getBoundingRectangle = function () {
    var a = this.getRelativeToSurfaceXY(this), b = this.outputConnection ? Blockly.BlockSvg.TAB_WIDTH : 0, c = this.getHeightWidth();
    if (this.RTL) {
...
Blockly.FieldColour.prototype.showEditor_ = function () {
    ...
    var a = Blockly.utils.getViewportBBox(), b = this.getScaledBBox_(), c = this.createWidget_(), d = goog.style.getSize(c.getElement());
...
Blockly.createDom_ = function (a, b) {
    ...
    var c = Blockly.utils.createSvgElement("svg", {
        ...
        version: "1.1",
        "class": "blocklySvg"
    }, a), d = Blockly.utils.createSvgElement("defs", {}, c), e = String(Math.random()).substring(2), f = Blockly.utils.createSvgElement("filter", {
